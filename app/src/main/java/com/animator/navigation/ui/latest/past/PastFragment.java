...
public class PastFragment extends Fragment {
    ...
    private PastAdapter newsAdapter;
    private ArrayList<Past> newsArrayList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newsArrayList = new ArrayList<Past>();
        getNewsList();
        return view;
    }
                        ...
                        try {
                            ...
                            if (obj.optString("status").equals("true")) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    JSONArray jArray = jObj.getJSONArray("pastevent");
                                    Log.d("pastEvent", String.valueOf(jObj.getJSONArray("pastevent")));
...
//                                    newsArrayList.add(playerModel1);
                                    }

                                }
                                newsAdapter = new PastAdapter(getContext(), newsArrayList);
