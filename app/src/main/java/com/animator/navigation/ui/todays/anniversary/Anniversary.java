...
public class Anniversary extends Fragment {
    ...
    private AnniversaryViewModel mViewModel;

    public static Anniversary newInstance() {
    ...
    private String data = BaseURL.getBaseUrl()+"Api/member/getmarriage";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(AnniversaryViewModel.class);
                ...
                try {
                    ...
                    if(obj.optString("status").equals("true")) {
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            playerModel.setName(dataobj.getString("w_first_name") + " "+ dataobj.getString("h_name"));
                            playerModel.setImage(imgPath + dataobj.getString("w_image"));
                            playerModel.setImageH(imgPath + dataobj.getString("h_image"));
