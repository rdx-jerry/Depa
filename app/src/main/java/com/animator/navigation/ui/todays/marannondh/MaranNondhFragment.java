...
import com.animator.navigation.ui.todays.birthday.EventAdapter;
...
public class MaranNondhFragment extends Fragment {
    ...
    private String data = BaseURL.getBaseUrl()+"Api/member/getmarannondh";
    String imgPath = BaseURL.getBaseUrl()+"uploads/marannondh/";
...
//                Event event;
                try {
                    ...
                    if(obj.optString("status").equals("true")) {
                        ...
                        eventAdapter = new MaranNondhAdapter(getContext(), events, "marannondh");
